...
const
   ...
   cSQL_ConsGrid = 'Select ab.bdIDAbastecimento, ab.bdDataHora, bomba.bdDescricao AS Bomba, comb.bdDescricao AS Combustivel,'#13 +
                   ...
                   '       bomba.bdIDBomba, tanque.bdIDTanques, comb.bdIDCombustivel'#13 +
